...
export const MODULES: ModuleDef[] = [
  ...
  { key: "rag", label: "RAG Knowledge Base", short: "RAG", desc: "Semantic policy retrieval with snippets", icon: BookOpen, group: "Assistant" },
  ...
  { key: "documents", label: "Document Intelligence", short: "Documents", desc: "OCR + entity extraction + compliance", icon: FileText, group: "Operations" },
